$(document).ready(function() {
    ...
    forms.submit(function(e) {
        ...
        for (var i = 0; i < file_field.length; i++) {
            ...
            if (file_field.length == 1) var num = add_upload_progress(form, file_field[i]);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    item.before($('<li class="list-group-item"><a href="' + url + '">' + name + '</a>&nbsp;<span>' + comment + '</span>&nbsp;<button name="material_id" value="' + m_id + '" class="btn btn-warning btn-sm pull-right delete-material-btn">Удалить</button></li>'));
                },
                complete: function () {
                    console.log( UPLOADS );
