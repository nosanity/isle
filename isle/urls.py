...
urlpatterns = [
    ...
    path('owner/team-material/<str:uid>/<int:team_id>/<int:material_id>/', upload.TeamMaterialOwnership.as_view(),
         name='team-material-owner'),
    path('owner/event-material/<str:uid>/<int:material_id>/', upload.EventMaterialOwnership.as_view(),
